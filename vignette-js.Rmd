...
To demonstrate how the `summarize()` function works, let’s summarize the news articles from the `crude` dataset. We can apply the summarization to the original text column and store the results in a new column, summary, as follows:
